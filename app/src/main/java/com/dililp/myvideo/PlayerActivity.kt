...
import com.dililp.myvideo.databinding.ActivityPlayerBinding
import com.dililp.myvideo.databinding.BoosterBinding
import com.dililp.myvideo.databinding.MoreFeaturesBinding
import com.dililp.myvideo.databinding.SpeedDialogBinding
...
class PlayerActivity : AppCompatActivity(), AudioManager.OnAudioFocusChangeListener , GestureDetector.OnGestureListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // for immersive mode (fullScreen mode)
        WindowCompat.setDecorFitsSystemWindows(window,false) // for hiding status bar
    ...
    private fun initializeLayout(){
        when(intent.getStringExtra("class")){
            ...
            "NowPlaying" -> {
                ...
                binding.playerView.player = player  // this is not in github
                doubleTapEnable()
                playVideo()
    ...
    private fun initializeBinding() {
       ...
       binding.lockBtn.setOnClickListener {
        ...
        // for auto hiding and showing lock button
        ...
        findViewById<ImageButton>(R.id.moreFeaturesBtn).setOnClickListener {
            ...
            bindingMF.audioTrack.setOnClickListener {
               ...
               val audioDialog =  MaterialAlertDialogBuilder(this, R.style.alertDialog)
                    ...
                    audioDialog.window?.setBackgroundDrawable(ColorDrawable(0x80000000.toInt()))
            }
            ...
            bindingMF.subtitleBtn.setOnClickListener {
                ...
                sDialog.window?.setBackgroundDrawable(ColorDrawable(0x80000000.toInt()))
            }
            ...
            bindingMF.sleepTimer.setOnClickListener {
                dialog.dismiss()
                if(timer != null) Toast.makeText(this, "Time Already Running!!\n Close App to Reset Sleep Timer!!",Toast.LENGTH_LONG).show()
                else{
                    var sleepTime = 15
                    val customDialogS= LayoutInflater.from(this).inflate(R.layout.speed_dialog, binding.root, false)
                    val bindingS = SpeedDialogBinding.bind(customDialogS)
            ...
            bindingMF.pipModeBtn.setOnClickListener {
                ...
                if(status){
                    this.enterPictureInPictureMode(PictureInPictureParams.Builder().build())
                        ...
                        val intent = Intent("android.setting.PICTURE_IN_PICTURE_SETTINGS",
                            Uri.parse("package:$packageName"))
                        startActivity(intent)
                    }
                }
                else{
                    Toast.makeText(this, "Feature is Not Supported In your Device!!", Toast.LENGTH_LONG).show()
                    dialog.dismiss()
                    playVideo()
                }
            }
...
//            }
   ...
   private fun seekBarfeature(){
    ...
    override fun onScroll(event: MotionEvent?, event1: MotionEvent?, distanceX: Float, distanceY: Float): Boolean {
        ...
        val border = 100 * Resources.getSystem().displayMetrics.density.toInt() // for converting 100 into pixels
