...
import com.dililp.myvideo.databinding.ActivityFoldersBinding
import java.io.File
...
class FoldersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.VideoRecyclerFA.adapter = adapter
            ...
            if(cursor.moveToNext())
                do {
                    ...
                    try {
                        ...
                        val video = Video(title = titleC, id = idC, folderName = folderC, duration = durationC, path = pathC, size = sizeC,
                            artUri = artUriC)
